<?php
    ...
    class OneDB_Protocol_FTP extends OneDB_Protocol {
        ...
        public function __construct( $host, $user, $pass, $path ) {
            ...
            if (!extension_loaded('ftp'))
                throw new Exception("In order to be able to use the FTP connector, you should have loaded the php-ftp extension!");
            ...
            parent::__construct( 'ftp', $host, $port, strlen( $user ) ? $user : 'anonymous', $pass, $path );
        ...
        public function getItems( $path = '/' ) {
            ...
            } else throw new Exception("Invalid ftp path: ftp://$this->_host:$this->_port$this->_path$path");
        ...
        public function getItemByPath( $path, $dumpDirectly = FALSE ) {
            ...
            if ($die) {
                ...
                header("Content-Type: " . @guessMimeByExtension( $this->_path( "ftp://$this->_conn/$path" )));
